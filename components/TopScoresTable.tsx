...
export default function TopScoresTable({
  ...
  return (
    <div className="flex max-h-[350px] sm:max-h-[500px] flex-col mb-2 m-1 p-3 rounded-lg bg-green-500 border-0 border-b-2 border-l-2 border-green-300 text-card-foreground shadow-sm">
