...
export default function useCategories() {
  ...
  const [finalCategories, setFinalCategories] =
    useState<categoryWithImageAndUrlType[]>();
  ...
  useEffect(() => {
    if (
      ...
      let combinedArray = dbCategories.map((category) => {
        const matchedImageAndUrl = categoryImagesAndUrls.find(
